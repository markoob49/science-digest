...
длительностью ровно 2 минуты (примерно 280–320 слов на русском языке).

Структура обзора:
1. Интригующее вступление: почему эта тема важна (15–20 сек)
2. Суть исследования: что изучали и как (40–50 сек)
3. Ключевые результаты: главные находки простым языком (40–50 сек)
4. Значение и перспективы: зачем это важно для науки и общества (20–25 сек)
5. Короткое заключение (5–10 сек)
